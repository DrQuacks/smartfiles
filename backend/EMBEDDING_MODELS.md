...
3. Built-in default profile `all-minilm-l6-v2`.
...
|----------------------|-------------------------------------------|------------------------------------------------|
| `all-minilm-l6-v2`   | `sentence-transformers/all-MiniLM-L6-v2`  | Default; very small 384d model, fast and local |
| `bge-small-en-v1`    | `BAAI/bge-small-en-v1`                    | 768d English model, good speed/quality         |
